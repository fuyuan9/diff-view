...
const He = ["a/", "b/", "i/", "w/", "c/", "o/"];
function J(i, t, n) {
  const e = n !== void 0 ? [...He, n] : He, r = t ? new RegExp(`^${tt(t)} "?(.+?)"?$`) : new RegExp('^"?(.+?)"?$'), [, s = ""] = r.exec(i) || [], a = e.find((c) => s.indexOf(c) === 0);
...
function je(i, t = {}) {
  ...
  const g = "--- ", y = "+++ ", L = "@@", o = /^old mode (\d{6})/, f = /^new mode (\d{6})/, v = /^deleted file mode (\d{6})/, p = /^new file mode (\d{6})/, T = /^copy from "?(.+)"?/, D = /^copy to "?(.+)"?/, N = /^rename from "?(.+)"?/, x = /^rename to "?(.+)"?/, E = /^similarity index (\d+)%/, O = /^dissimilarity index (\d+)%/, j = /^index ([\da-z]+)\.\.([\da-z]+)\s*(\d{6})?/, l = /^Binary files (.*) and (.*) differ/, d = /^GIT binary patch/, b = /^index ([\da-z]+),([\da-z]+)\.\.([\da-z]+)/, C = /^mode (\d{6}),(\d{6})\.\.(\d{6})/, A = /^new file mode (\d{6})/, R = /^deleted file mode (\d{6}),(\d{6})/, z = i.replace(/\\ No newline at end of file/g, "").replace(/\r\n?/g, `
`).split(`
`);
  function I() {
  ...
  function B(m) {
    ...
    Fe(m, w) ? (e.addedLines++, S.type = F.INSERT, S.oldNumber = void 0, S.newNumber = u++) : Fe(m, $) ? (e.deletedLines++, S.type = F.DELETE, S.oldNumber = s++, S.newNumber = void 0) : (S.type = F.CONTEXT, S.oldNumber = s++, S.newNumber = u++), r.lines.push(S);
  }
  function Q(m, S) {
    let w = S;
    for (; w < z.length - 3; ) {
      if (m.startsWith("diff"))
        return !1;
      if (z[w].startsWith(g) && z[w + 1].startsWith(y) && z[w + 2].startsWith(L))
        return !0;
      w++;
    }
    return !1;
  }
  return z.forEach((m, S) => {
    if (!m || m.startsWith("*"))
      return;
    let w;
    const $ = z[S - 1], ne = z[S + 1], me = z[S + 2];
    ...
    if (m.startsWith("Binary files") && !(e != null && e.isGitDiff)) {
      if (Y(), (w = /^Binary files "?([a-ciow]\/.+)"? and "?([a-ciow]\/.+)"? differ/.exec(m)) && (c = J(w[1], void 0, t.dstPrefix), h = J(w[2], void 0, t.srcPrefix)), e === null)
        throw new Error("Where is my file !!!");
      e.isBinary = !0;
      return;
    }
    if ((!e || !e.isGitDiff && e && m.startsWith(g) && ne.startsWith(y) && me.startsWith(L)) && Y(), e != null && e.isTooBig)
      return;
    ...
    if (m.startsWith(g) && ne.startsWith(y) || m.startsWith(y) && $.startsWith(g)) {
      if (e && !e.oldName && m.startsWith("--- ") && (w = it(m, t.srcPrefix))) {
        e.oldName = w, e.language = Me(e.oldName, e.language);
        return;
      }
      if (e && !e.newName && m.startsWith("+++ ") && (w = rt(m, t.dstPrefix))) {
        e.newName = w, e.language = Me(e.newName, e.language);
        return;
      }
    }
...
W.prototype = {
  diff: function(t, n) {
    ...
    if (f[0].oldPos + 1 >= h && v + 1 >= c)
      return u(Ae(a, f[0].lastComponent, n, t, a.useLongestToken));
    var p = -1 / 0, T = 1 / 0;
    function D() {
      for (var x = Math.max(p, -g); x <= Math.min(T, g); x += 2) {
        ...
        if (!b || l && O.oldPos < j.oldPos ? E = a.addToPath(j, !0, !1, 0, r) : E = a.addToPath(O, !1, !0, 1, r), v = a.extractCommon(E, n, t, x, r), E.oldPos + 1 >= h && v + 1 >= c)
          return u(Ae(a, E.lastComponent, n, t, a.useLongestToken));
...
var fe = "a-zA-Z0-9_\\u{C0}-\\u{FF}\\u{D8}-\\u{F6}\\u{F8}-\\u{2C6}\\u{2C8}-\\u{2D7}\\u{2DE}-\\u{2FF}\\u{1E00}-\\u{1EFF}", ot = new RegExp("[".concat(fe, "]+|\\s+|[^").concat(fe, "]"), "ug"), de = new W();
de.equals = function(i, t, n) {
  return n.ignoreCase && (i = i.toLowerCase(), t = t.toLowerCase()), i.trim() === t.trim();
};
de.tokenize = function(i) {
...
de.postProcess = function(i, t) {
  if (!i || t.oneChangePerToken)
    return i;
  var n = null, e = null, r = null;
  return i.forEach(function(s) {
    s.added ? e = s : s.removed ? r = s : ((e || r) && Re(n, r, e, s), n = s, e = null, r = null);
  }), (e || r) && Re(n, r, e, null), i;
};
function Re(i, t, n, e) {
  if (t && n) {
    ...
    if (i) {
      var c = Be(r, a);
      i.value = we(i.value, a, c), t.value = re(t.value, c), n.value = re(n.value, c);
    }
    if (e) {
      var h = Pe(s, u);
      e.value = ve(e.value, u, h), t.value = oe(t.value, h), n.value = oe(n.value, h);
    }
  } else if (n)
    i && (n.value = n.value.replace(/^\s*/, "")), e && (e.value = e.value.replace(/^\s*/, ""));
  else if (i && e) {
    var g = e.value.match(/^\s*/)[0], y = t.value.match(/^\s*/)[0], L = t.value.match(/\s*$/)[0], o = Be(g, y);
    t.value = re(t.value, o);
    var f = Pe(re(g, o), L);
    t.value = oe(t.value, f), e.value = ve(e.value, g, f), i.value = we(i.value, g, g.slice(0, g.length - f.length));
  } else if (e) {
    var v = e.value.match(/^\s*/)[0], p = t.value.match(/\s*$/)[0], T = ze(p, v);
    t.value = oe(t.value, T);
  } else if (i) {
    var D = i.value.match(/\s*$/)[0], N = t.value.match(/^\s*/)[0], x = ze(D, N);
...
function ft(i, t, n) {
  return Ge.diff(i, t, n);
}
var Ce = new W();
Ce.tokenize = function(i, t) {
...
var ct = new W();
ct.tokenize = function(i) {
  return i.split(/(\S.+?[.!?])(?=\s+|$)/);
};
var ut = new W();
ut.tokenize = function(i) {
  return i.split(/([{}:;,]|\s+)/);
};
function ye(i) {
...
Ne.join = Ne.removeEmpty = function(i) {
  return i;
};
function dt(i, t) {
  if (i.length === 0)
...
function xe(i) {
  return (t, n) => {
    ...
    return dt(e, r) / (e.length + r.length);
  };
}
function Ee(i) {
...
function pe(i) {
  const t = De(i.oldName), n = De(i.newName);
  if (t !== n && !ge(t) && !ge(n)) {
  ...
  } else return ge(n) ? t : n;
}
function Se(i) {
  return `d2h-${nt(pe(i)).toString().slice(-6)}`;
}
function Oe(i) {
  let t = "file-changed";
...
function _e(i, t, n, e = {}) {
  const { matching: r, maxLineLengthHighlight: s, matchWordsThreshold: a, diffStyle: u } = Object.assign(Object.assign({}, he), e), c = _(i, n, !1), h = _(t, n, !1);
  ...
  const g = u === "char" ? at(c.content, h.content) : ft(c.content, h.content), y = [];
  if (u === "word" && r === "words") {
    const o = g.filter((p) => p.removed), f = g.filter((p) => p.added);
    ht(f, o).forEach((p) => {
      p[0].length === 1 && p[1].length === 1 && Ue(p[0][0], p[1][0]) < a && (y.push(p[0][0]), y.push(p[1][0]));
    });
  }
...
const ke = "file-summary", gt = "icon", vt = {
  colorScheme: he.colorScheme
};
class wt {
  constructor(t, n = {}) {
    this.hoganUtils = t, this.config = Object.assign(Object.assign({}, vt), n);
  }
  render(t) {
    const n = t.map((e) => this.hoganUtils.render(ke, "line", {
      fileHtmlId: Se(e),
      oldName: e.oldName,
      newName: e.newName,
      fileName: pe(e),
      ...
      fileIcon: this.hoganUtils.template(gt, Oe(e))
    })).join(`
`);
    return this.hoganUtils.render(ke, "wrapper", {
      colorScheme: Le(this.config.colorScheme),
      filesNumber: t.length,
      files: n
    });
  }
}
const Ve = Object.assign(Object.assign({}, he), { renderNothingWhenEmpty: !1, matchingMaxComparisons: 2500, maxLineSizeInBlockForComparison: 200 }), se = "generic", $e = "line-by-line", yt = "icon", Tt = "tag";
class Nt {
  constructor(t, n = {}) {
    this.hoganUtils = t, this.config = Object.assign(Object.assign({}, Ve), n);
  }
  render(t) {
    const n = t.map((e) => {
      let r;
...
`);
  ...
  makeFileDiffHtml(t, n) {
    if (this.config.renderNothingWhenEmpty && Array.isArray(t.blocks) && t.blocks.length === 0)
      return "";
    const e = this.hoganUtils.template($e, "file-diff"), r = this.hoganUtils.template(se, "file-path"), s = this.hoganUtils.template(yt, "file"), a = this.hoganUtils.template(Tt, Oe(t));
    return e.render({
      file: t,
      fileHtmlId: Se(t),
      diffs: n,
  ...
  generateFileHtml(t) {
    const n = Ee(xe((e) => _(e.content, t.isCombined).content));
...
`);
  ...
  applyLineGroupping(t) {
    ...
    for (let s = 0; s < t.lines.length; s++) {
      const a = t.lines[s];
      (a.type !== F.INSERT && r.length || a.type === F.CONTEXT && e.length > 0) && (n.push([[], e, r]), e = [], r = []), a.type === F.CONTEXT ? n.push([[a], [], []]) : a.type === F.INSERT && e.length === 0 ? n.push([[], [], [a]]) : a.type === F.INSERT && e.length > 0 ? r.push(a) : a.type === F.DELETE && e.push(a);
    }
    return (e.length || r.length) && (n.push([[], e, r]), e = [], r = []), n;
  }
  applyRematchMatching(t, n, e) {
    const r = t.length * n.length, s = We(t.concat(n).map((u) => u.content.length));
  ...
  processChangedLines(t, n, e, r) {
    ...
    for (let u = 0; u < a; u++) {
      const c = e[u], h = r[u], g = c !== void 0 && h !== void 0 ? _e(c.content, h.content, n, this.config) : void 0, y = c !== void 0 && c.oldNumber !== void 0 ? Object.assign(Object.assign({}, g !== void 0 ? {
        prefix: g.oldLine.prefix,
        content: g.oldLine.content,
        type: P.DELETE_CHANGES
  ...
  generateSingleLineHtml(t, n) {
    if (n === void 0)
      return "";
    const e = this.hoganUtils.render($e, "numbers", {
...
const Xe = Object.assign(Object.assign({}, he), { renderNothingWhenEmpty: !1, matchingMaxComparisons: 2500, maxLineSizeInBlockForComparison: 200 }), ae = "generic", Ct = "side-by-side", xt = "icon", Et = "tag";
class Lt {
  constructor(t, n = {}) {
    this.hoganUtils = t, this.config = Object.assign(Object.assign({}, Xe), n);
  }
  render(t) {
    const n = t.map((e) => {
      let r;
...
`);
  ...
  makeFileDiffHtml(t, n) {
    if (this.config.renderNothingWhenEmpty && Array.isArray(t.blocks) && t.blocks.length === 0)
      return "";
    const e = this.hoganUtils.template(Ct, "file-diff"), r = this.hoganUtils.template(ae, "file-path"), s = this.hoganUtils.template(xt, "file"), a = this.hoganUtils.template(Et, Oe(t));
    return e.render({
      file: t,
      fileHtmlId: Se(t),
      diffs: n,
  ...
  makeHeaderHtml(t, n) {
    return this.hoganUtils.render(ae, "block-header", {
      CSSLineClass: P,
      blockHeader: n != null && n.isTooBig ? t : te(t),
  ...
  processChangedLines(t, n, e) {
    ...
    for (let a = 0; a < s; a++) {
      const u = n[a], c = e[a], h = u !== void 0 && c !== void 0 ? _e(u.content, c.content, t, this.config) : void 0, g = u !== void 0 && u.oldNumber !== void 0 ? Object.assign(Object.assign({}, h !== void 0 ? {
  ...
  generateSingleHtml(t) {
    ...
    return this.hoganUtils.render(ae, "line", {
      type: (t == null ? void 0 : t.type) || `${P.CONTEXT} d2h-emptyplaceholder`,
...
(function(i) {
  (function(t) {
    ...
    t.tags = {
      ...
      var C = d.length, A = 0, R = 1, z = 2, I = A, q = null, Y = null, k = "", B = [], Q = !1, m = 0, S = 0, w = "{{", $ = "}}";
      function ne() {
      ...
      function Z(V, G) {
        if (ne(), V && me())
          for (var X = S, K; X < B.length; X++)
            B[X].text && ((K = B[X + 1]) && K.tag == ">" && (K.indent = B[X].text.toString()), B.splice(X, 1));
        else G || B.push({ tag: `
` });
        Q = !1, S = B.length;
      }
      function ie(V, G) {
        var X = "=" + $, K = V.indexOf(X, G), be = g(
          V.substring(V.indexOf("=", G) + 1, K)
        ).split(" ");
        return w = be[0], $ = be[be.length - 1], K + X.length - 1;
      }
      for (b && (b = b.split(" "), w = b[0], $ = b[1]), m = 0; m < C; m++)
        I == A ? y(w, d, m) ? (--m, ne(), I = R) : d.charAt(m) == `
` ? Z(Q) : k += d.charAt(m) : I == R ? (m += w.length - 1, Y = t.tags[d.charAt(m + 1)], q = Y ? d.charAt(m + 1) : "_v", q == "=" ? (m = ie(d, m), I = A) : (Y && m++, I = z), Q = m) : y($, d, m) ? (B.push({
          tag: q,
          n: g(k),
          otag: w,
          ctag: $,
          i: q == "/" ? Q - w.length : m + $.length
        }), k = "", m += $.length - 1, I = A, q == "{" && ($ == "}}" ? m++ : h(B[B.length - 1]))) : k += d.charAt(m);
      return Z(Q, !0), B;
    };
    function h(l) {
    ...
    var L = { _t: !0, "\n": !0, $: !0, "/": !0 };
    function o(l, d, b, C) {
      var A = [], R = null, z = null, I = null;
      for (z = b[b.length - 1]; l.length > 0; ) {
        if (I = l.shift(), z && z.tag == "<" && !(I.tag in L))
        ...
        if (t.tags[I.tag] <= t.tags.$ || f(I, C))
          ...
          if (R = b.pop(), I.n != R.n && !v(I.n, R.n, C))
            throw new Error("Nesting error: " + R.n + " vs. " + I.n);
          return R.end = I.i, A;
        } else I.tag == `
...
var ue = qe;
ue.Template = Je.Template;
ue.template = ue.Template;
var M = ue;
const H = {};
H["file-summary-line"] = new M.Template({ code: function(i, t, n) {
  var e = this;
...
H["file-summary-wrapper"] = new M.Template({ code: function(i, t, n) {
  var e = this;
...
H["generic-block-header"] = new M.Template({ code: function(i, t, n) {
  var e = this;
...
H["generic-empty-diff"] = new M.Template({ code: function(i, t, n) {
  var e = this;
  return e.b(n = n || ""), e.b("<tr>"), e.b(`
` + n), e.b('    <td class="'), e.b(e.v(e.d("CSSLineClass.INFO", i, t, 0))), e.b('">'), e.b(`
...
H["generic-file-path"] = new M.Template({ code: function(i, t, n) {
  var e = this;
...
H["generic-line"] = new M.Template({ code: function(i, t, n) {
  var e = this;
  return e.b(n = n || ""), e.b("<tr>"), e.b(`
...
H["icon-file-changed"] = new M.Template({ code: function(i, t, n) {
  var e = this;
...
H["icon-file-deleted"] = new M.Template({ code: function(i, t, n) {
  var e = this;
...
H["icon-file-renamed"] = new M.Template({ code: function(i, t, n) {
  var e = this;
...
H["icon-file"] = new M.Template({ code: function(i, t, n) {
  var e = this;
...
H["line-by-line-file-diff"] = new M.Template({ code: function(i, t, n) {
  var e = this;
...
H["line-by-line-numbers"] = new M.Template({ code: function(i, t, n) {
  var e = this;
...
H["side-by-side-file-diff"] = new M.Template({ code: function(i, t, n) {
  var e = this;
  return e.b(n = n || ""), e.b('<div id="'), e.b(e.v(e.f("fileHtmlId", i, t, 0))), e.b('" class="d2h-file-wrapper" data-lang="'), e.b(e.v(e.d("file.language", i, t, 0))), e.b('">'), e.b(`
` + n), e.b('    <div class="d2h-file-header">'), e.b(`
` + n), e.b("      "), e.b(e.t(e.f("filePath", i, t, 0))), e.b(`
...
class St {
  constructor({ compiledTemplates: t = {}, rawTemplates: n = {} }) {
    ...
    this.preCompiledTemplates = Object.assign(Object.assign(Object.assign({}, H), t), e);
  }
  static compile(t) {
...
const Ie = Object.assign(Object.assign(Object.assign({}, Ve), Xe), { outputFormat: Ye.LINE_BY_LINE, drawFileList: !0 });
function Ot(i, t = {}) {
  return je(i, Object.assign(Object.assign({}, Ie), t));
}
function It(i, t = {}) {
  const n = Object.assign(Object.assign({}, Ie), t), e = typeof i == "string" ? je(i, n) : i, r = new St(n), { colorScheme: s } = n, a = { colorScheme: s }, u = n.drawFileList ? new wt(r, a).render(e) : "", c = n.outputFormat === "side-by-side" ? new Lt(r, n).render(e) : new Nt(r, n).render(e);
  return u + c;
}
